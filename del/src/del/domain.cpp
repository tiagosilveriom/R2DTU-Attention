...
// Top down attention shift - version 1
	...
	std::pair<action_id, state_id> domain::peform_private_top_down(agent_id i, std::vector<proposition_id> add, std::vector<proposition_id>  del)
	{
...
// Top Down attention shift - version 2.2
	std::pair<action_id, state_id> domain::peform_conscious_top_down(agent_id i, std::vector<proposition_id> add, std::vector<proposition_id>  del)
	{
		action_id ac_action_id = { static_cast<size_type>(this->actions.size()) };
